package com.t1.popcon.ticket.config;
...
import com.t1.popcon.ticket.filter.InternalApiAuthFilter;
...
public class TicketSecurityConfig extends CommonSecurityConfig {

    private final InternalApiAuthFilter internalApiAuthFilter;

    public TicketSecurityConfig(
        JwtFilter jwtFilter,
