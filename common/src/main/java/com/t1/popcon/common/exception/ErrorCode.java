...
public enum ErrorCode {
    ...
    NICKNAME_DUPLICATED("U003", HttpStatus.CONFLICT, "이미 사용중인 닉네임입니다."),
    ...
    // File
    INVALID_FILE_TYPE("F001", HttpStatus.BAD_REQUEST, "JPG, PNG 형식의 파일만 업로드 가능합니다."),
    FILE_SIZE_EXCEEDED("F002", HttpStatus.BAD_REQUEST, "파일 크기는 5MB 이하여야 합니다."),
    ...
    BILLING_KEY_ALREADY_EXISTS("P006", HttpStatus.CONFLICT, "이미 등록된 결제 수단입니다."),
