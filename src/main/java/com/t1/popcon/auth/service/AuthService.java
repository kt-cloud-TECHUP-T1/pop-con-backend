...
import com.t1.popcon.auth.repository.RefreshTokenRepository;
...
public class AuthService {
	...
	public AuthResponse.Signup signup(AuthRequest.Signup request) {
		...
		String ciHashFromAuth = "test_ci_1234";
		...
		String accessToken = tokenProvider.createToken(String.valueOf(savedUser.getId()), jwtProperties.getAccessTokenExpiration());
		String refreshTokenString = tokenProvider.createToken(String.valueOf(savedUser.getId()), jwtProperties.getRefreshTokenExpiration());
